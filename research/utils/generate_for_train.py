...
try:
    ...
    print("[WARNING] MediaPipe not available. Pose estimation will be skipped.")
...
def _generate_for_train(root_dir):
    if not MEDIAPIPE_AVAILABLE:
        print("[ERROR] MediaPipe is required for pose estimation. Please install mediapipe.")
        print("You can try: pip install mediapipe")
        return
